...
def pml_setup():
    """
    Setup PML instance for testing.

    Returns:
        tuple: (LcPML instance, dolfinx mesh)
    """
    # Init PML
...
def test_csi_bounds(pml_setup):
    """
    Test PML coordinate limits.

    Args:
        pml_setup (tuple): (LcPML instance, dolfinx mesh)
...
def test_normal_magnitudes(pml_setup):
    """
    Test unit magnitude of PML normal vectors.
